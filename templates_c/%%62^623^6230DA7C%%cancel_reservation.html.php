<?php /* Smarty version 2.6.10, created on 2012-10-08 18:41:06
         compiled from cancel_reservation.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'cancel_reservation.html', 8, false),array('modifier', 'date_format', 'cancel_reservation.html', 9, false),)), $this); ?>
...
<form action="<?php echo $this->_tpl_vars['ctl']->url('reservation','confirm_cancel'); ?>
" method="post">

<p>Are you sure you want to cancel the reservation for:<br />
...
<p><input type="submit" value="Yes, cancel it." style="margin-right: 20px;" />
